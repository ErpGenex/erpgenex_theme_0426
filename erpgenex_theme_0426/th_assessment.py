...
from erpgenex_theme_0426.th_gap_register import get_gap_status
from erpgenex_theme_0426.th_global_benchmark import get_global_th_score

@frappe.whitelist()
def export_th_global_audit() -> dict:
	root = os.path.join(get_bench_path(), "Docs", "2026-06-06_ERPGENEX_THEME_0426_GLOBAL_AUDIT")
	os.makedirs(root, exist_ok=True)
	score, gaps = get_global_th_score(), get_gap_status()
